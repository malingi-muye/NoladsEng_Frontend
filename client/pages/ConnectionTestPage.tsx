...
const ConnectionTestPage = () => {
  ...
  useEffect(() => {
    const testConnections = async () => {
      ...
      try {
        const companyResponse = await api.company.getInfo();
        updateConnection('companyInfo', {
          status: 'success',
          message: `✅ Company Info loaded: ${companyResponse.data?.name}`,
      ...
      try {
        ...
        updateConnection('companyStats', {
          status: 'success',
          message: `✅ Company Stats loaded: ${statsResponse.data?.completedProjects} projects`,
      ...
      try {
        const contactResponse = await api.company.getContact();
        updateConnection('companyContact', {
          status: 'success',
          message: `✅ Company Contact loaded: ${Object.keys(contactResponse.data?.offices || {}).length} offices`,
