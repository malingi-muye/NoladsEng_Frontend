...
const ServiceCard = React.forwardRef<HTMLDivElement, ServiceCardProps>(
  (
    { icon: Icon, title, description, features, action, className, ...props },
    ref,
  ) => (
    <ModernCard
      ref={ref}
    ...
    >
      <CardHeader className="text-white">
        <div className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center mb-3.5 group-hover:bg-blue-200 transition-colors">
